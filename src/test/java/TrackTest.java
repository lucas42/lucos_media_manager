...
class TrackTest {
	...
	void extUrl() {
		...
		final Track trackWithCustomExtUrl = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("exturl", "https://example.com/viewdetails")));
		assertEquals("https://example.com/viewdetails", trackWithCustomExtUrl.getMetadata("exturl"));
		final Track bbcProgrammeTrack = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("pid", "b006q2x0")));
		assertEquals("https://www.bbc.co.uk/programmes/b006q2x0", bbcProgrammeTrack.getMetadata("exturl"));
		final Track musicbrainzArtistTrack = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("mbid_artist", "db92a151-1ac2-438b-bc43-b82e149ddd50")));
	...
	void editUrl() {
		...
		final Track trackWithCustomEditUrl = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("editurl", "https://example.com/edit")));
		assertEquals("https://example.com/edit", trackWithCustomEditUrl.getMetadata("editurl"));
		final Track standardTrack = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("trackid", "42")));
	...
	void img() {
		...
		final Track trackWithCustomImg = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("img", "https://example.com/pic.png")));
	...
	void thumb() {
		...
		final Track trackWithCustomThumb = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("thumb", "https://example.com/thumb.png")));
		assertEquals("https://example.com/thumb.png", trackWithCustomThumb.getMetadata("thumb"));
	}
	@Test
	void title() {
		final Track trackWithCustomTitle = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("title", "Track One")));
	...
	void isNew() {
		...
		final Track trackWithRecentAdded = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("added", lastWeek)));
		...
		final Track trackWithRecentAddedTimezone = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("added", lastWeekPlusTimezone)));
		...
		final Track trackWithOldAdded = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("added", severalWeeksAgo)));
		...
		final Track trackWithInvalidAdded = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("added", "yes")));
		assertEquals(null, trackWithNoAdded.getMetadata("new"));
		final Track trackWithIncorrectNewField = new Track(mock(MediaApi.class), "https://example.com/track", new HashMap<String, String>(Map.of("added", severalWeeksAgo, "new", "true")));
